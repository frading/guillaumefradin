Guillaumefradin::Application.configure do
  ...
  # NOTE: for now it creates a problem when I go to https://printmosaic.com (no www)
  # and the browser complains that the site might not be the one it pretends to be
  ...
  # devise
  # config.action_mailer.default_url_options = { :host => "mozaiku.us" }
